...
class VitExtractor:
    ...
    def __init__(self, model_name, device):#facebookresearch/dino:main
        self.model = torch.hub.load("MagicMakeup/evaluate/dino", model_name, source='local').to(device)
        # self.model = torch.hub.load("facebookresearch/dino:main", model_name).to(device)
        
        self.model.eval()
        # checkpoint_path = "MagicMakeup/evaluate/dino/dino_vitbase8_pretrain_full_checkpoint.pth"
